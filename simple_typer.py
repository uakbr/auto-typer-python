...
class SimpleTyper(QMainWindow):
    ...
    def start_typing(self):
        ...
        if not text:
            QMessageBox.information(self, "No Text", "Please enter some text to type")
            return
        
        # Show countdown message
        result = QMessageBox.question(
            self, "Ready to Type", 
            "Click OK, then immediately click where you want to type.\n"
            "You have 3 seconds to position your cursor.",
    ...
    def typing_process(self, text):
        ...
        try:
                ...
                for char in text:
                    ...
                    if self.natural_typing:
                        if char in ['.', ',', '!', '?', ';', ':']:
                            ...
                            time.sleep(self.delay + random.uniform(-self.delay*0.3, self.delay*0.3))
                    else:
                        # Fixed delay
            ...
            QTimer.singleShot(0, lambda: self.show_error(f"Error during typing: {str(e)}"))
    ...
    def emergency_stop(self):
        ...
        if self.typing_active:
            ...
            QMessageBox.warning(self, "Emergency Stop", 
                               "Typing has been stopped by emergency timeout or ESC key")
